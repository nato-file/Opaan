...
cl = LINETCR.LINE()
cl.login(token='EmNYBpVC1vxlQYziVZtf.Sx0WtkGgb8q8KkR1E/39tW.BfON01N3LqCJsjWlJRzP9SZphvzJ9X3WvcPGZsIZmT4=')
cl.loginResult()
...
admin=["u936bd1adc302473f22baa4f58c380c41"]
wait = {
    'contact':True,
    'autoJoin':True,
    ...
    try:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                if wait["cancelprotect"] == True: md+"􀜁􀇔􏿿 Cancel Protect:on 🔓\n"
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                judul=msg.text.lower().replace('/yt-search ',"")
                ...
                for a in soup.select('.yt-lockup-title > a[title]'):
                    if '&list=' not in a['href']:
                        ...
                        #print('http://www.youtube.com' + a['title'])
...
#----------------------------------------------------------------
            elif msg.text == "FlowTrans":
                text = "FlowBot Translator\n'tr: ' -> To Indo\n'tr-en: ' -> Indonesia-English"
            elif "tr: " in msg.text:
